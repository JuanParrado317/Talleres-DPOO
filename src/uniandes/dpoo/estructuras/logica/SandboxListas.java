...
public class SandboxListas
{
    ...
    {
        // No se usa remove(Object) directamente con un int en un for-each porque el autoboxing
        // interpretaría el número como una posición si se usara Integer.valueOf mal; en cambio
        // usamos removeIf con el valor primitivo comparado explícitamente.
    ...
    public void insertarEntero( int entero, int posicion )
    {
        ...
        if( posicionReal > listaEnteros.size( ) )
        {
            posicionReal = listaEnteros.size( );
        }
    ...
    {
        List<Integer> yaContados = new ArrayList<Integer>( );
        int repetidos = 0;
        for( Integer valor : listaEnteros )
        {
