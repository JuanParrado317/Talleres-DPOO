...
public class SandboxArreglos
{
    ...
    public void insertarEntero( int entero, int posicion )
    {
        ...
        if( posicionReal > arregloEnteros.length )
        {
            posicionReal = arregloEnteros.length;
        }
        ...
        nuevoArreglo[ posicionReal ] = entero;
        for( int i = posicionReal; i < arregloEnteros.length; i++ )
        {
    ...
    public void eliminarEnteroPorPosicion( int posicion )
    {
        ...
        for( int i = 0; i < arregloEnteros.length; i++ )
        {
            if( i != posicion )
            {
                nuevoArreglo[ posicionNueva ] = arregloEnteros[ i ];
                posicionNueva++;
            }
        }
        arregloEnteros = nuevoArreglo;
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        Arrays.sort( copiaPropia );
        Arrays.sort( copiaOtro );
        return Arrays.equals( copiaPropia, copiaOtro );
    }
