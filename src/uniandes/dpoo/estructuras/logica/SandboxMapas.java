...
public class SandboxMapas
{
    ...
    {
        List<String> copia = new ArrayList<String>( mapaCadenas.values( ) );
    ...
    {
        List<String> copia = new ArrayList<String>( mapaCadenas.keySet( ) );
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        for( Map.Entry<String, String> entrada : mapaCadenas.entrySet( ) )
        {
            ...
            {
                llaveEncontrada = entrada.getKey( );
                break;
            }
        }
